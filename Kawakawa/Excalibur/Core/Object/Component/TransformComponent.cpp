...
namespace Excalibur
{
	...
	Vector3f TransformComponent::GlobalVectorToLocalVector(Vector3f globalVector)
	{
	...
	Vector3f TransformComponent::LocalPointToGlobalPoint(Vector3f localPoint)
	{
	...
	Matrix3x3f TransformComponent::GetRatationMatrixGlobal2Local33()
	{
		Matrix4x4f world2local = GetWorldMatrixInverse();
		Matrix3x3f ret;
		for (int i = 0; i < 3; i++)
