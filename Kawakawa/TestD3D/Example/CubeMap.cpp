...
void CubeMapApp::BuildDescriptorHeaps()
{
	...
	srvHeapDesc.NumDescriptors = 5; // 1 for cubemap and 4 for texture2D
...
void CubeMapApp::BuildShadersAndInputLayout()
{
	...
	mShaders["standardVS"] = d3dUtil::CompileShader(L"Shaders\\CubeMapping\\Default.hlsl", nullptr, "VS", "vs_5_1");
	mShaders["opaquePS"] = d3dUtil::CompileShader(L"Shaders\\CubeMapping\\Default.hlsl", nullptr, "PS", "ps_5_1");

	mShaders["skyVS"] = d3dUtil::CompileShader(L"Shaders\\CubeMapping\\Sky.hlsl", nullptr, "VS", "vs_5_1");
	mShaders["skyPS"] = d3dUtil::CompileShader(L"Shaders\\CubeMapping\\Sky.hlsl", nullptr, "PS", "ps_5_1");
