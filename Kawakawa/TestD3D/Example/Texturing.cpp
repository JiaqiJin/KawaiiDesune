...
void TexColumnsApp::LoadTextures()
{
	...
	bricksTex->Filename = L"Texture/bricks.dds";
	...
	tileTex->Filename = L"Texture/tile.dds";
	ThrowIfFailed(DirectX::CreateDDSTextureFromFile12(md3dDevice.Get(),
...
void TexColumnsApp::BuildShadersAndInputLayout()
{
	...
	mShaders["standardVS"] = d3dUtil::CompileShader(L"Shaders\\Texture\\Default.hlsl", nullptr, "VS", "vs_5_0");
	mShaders["opaquePS"] = d3dUtil::CompileShader(L"Shaders\\Texture\\Default.hlsl", nullptr, "PS", "ps_5_0");
