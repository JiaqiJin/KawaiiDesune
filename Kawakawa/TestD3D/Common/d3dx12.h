...
//------------------------------------------------------------------------------------------------
// Returns required size of a buffer to be used for bytecode upload
...
public:
    ...
    operator const D3D12_STATE_OBJECT_DESC& ()
    {
        ...
        // Below: using ugly way to get pointer in case .bytecode() is not defined
...
public:
        ...
        D3D12_EXPORT_FLAGS Flags = D3D12_EXPORT_FLAG_NONE)
    {
        ...
        m_Desc.pExports = &m_Exports[0];  // using ugly way to get pointer in case .bytecode() is not defined
