...
Excalibur::ShaderD11::ShaderD11(const string & vsPath, const string & psPath)
{
	InitializeFromFile(vsPath, psPath);
}

Excalibur::ShaderD11::~ShaderD11()
{
	Finialize();
}

bool Excalibur::ShaderD11::InitializeFromFile(const string & vsPath, const string & psPath) noexcept
{
...
void Excalibur::ShaderD11::Use() noexcept
{
	auto mgrd11 = (GraphicsMgrD11*)GApp->mGraphicsManager;
...
void Excalibur::ShaderD11::Finialize() noexcept
{
...
void Excalibur::ShaderD11::SetConstantBuffer(const ConstantBuffer & cbuffer) noexcept
{
	auto mgrd11 = (GraphicsMgrD11*)GApp->mGraphicsManager;
